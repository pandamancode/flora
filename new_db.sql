...
--
-- Host: localhost:3306
-- Generation Time: Jan 09, 2021 at 10:48 AM
...
--
-- Database: `kalomyid_klinik_flora`
--
...
(1, '10283892', 'Afif Wijaya', '1996-01-07', 'L', 'Labuhan Ratu', 'POLDA LAMPUNG', 'POLDA LAMPUNG', 'IT', 'BRIPKA', '0182391283918', 'UMUM', '2021-01-07 02:57:04'),
(2, '74293894829', 'arta', '2021-01-07', 'L', 'sdfsdf', 'polda lampung', 'polresta bandarlampung', 'lantas', 'bripka', '7809', 'UMUM', '2021-01-07 12:10:02'),
(3, '1610021621-10', 'andri', '2017-06-05', 'L', 'rthjj', 'polri', 'polsek', 'lantas', 'bripol', '09876', 'UMUM', '2021-01-08 08:09:30');
...
('INV210105001', '210105001', '2021-01-04 18:43:35', 'mual', 180, 80, 55, 24, NULL, NULL, NULL, NULL, 2, 150000, 'selesai', 'sudah', NULL),
('INV210105002', '210105002', '2021-01-04 20:00:38', 'asdf', 155, 45, 27, 18, NULL, NULL, NULL, NULL, 1, 250000, 'selesai', 'sudah', NULL),
('INV210105003', '210105003', '2021-01-04 20:13:25', '-', 160, 50, 29, 19, NULL, NULL, NULL, NULL, 1, 250000, 'selesai', 'sudah', NULL),
('INV210105004', '210105004', '2021-01-04 20:17:45', '-', 155, 50, 25, 20, NULL, NULL, NULL, NULL, 2, 150000, 'selesai', 'sudah', NULL),
('INV210105005', '210105005', '2021-01-04 20:32:43', '-', 160, 60, 30, 23, NULL, NULL, NULL, NULL, 1, 250000, 'selesai', 'sudah', NULL),
('INV210105006', '210105006', '2021-01-04 20:53:46', '-', 160, 70, 55, 27, NULL, NULL, NULL, NULL, 1, 250000, 'selesai', 'sudah', NULL),
('INV210106001', '210106001', '2021-01-06 03:20:27', '-', 180, 80, 35, 24, '22', '22', '22', '22', NULL, NULL, 'selesai', 'belum', NULL),
('INV210107001', '210107001', '2021-01-07 16:36:41', 'mual, pusing', 180, 50, 55, 15, '-', '-', '-', '-', NULL, NULL, 'dalam proses', 'belum', 'makan teratur'),
('INV210107002', '210107002', '2021-01-07 17:38:51', 'pusing', 180, 80, 50, 24, '-', '-', '-', '-', NULL, NULL, 'dalam proses', 'belum', 'jgn banyak pikiran'),
('INV210107003', '210107003', '2021-01-08 04:50:50', 'Sakit pinggang', 165, 50, 30, 18, '35', '55', '30', '5', NULL, NULL, 'dalam proses', 'belum', 'Banyak minum');
...
(1, 'admin', 'admin', '202cb962ac59075b964b07152d234b70', '', '2021-01-08 07:21:41');
...
--
ALTER TABLE `ekg`
  MODIFY `id_ekg` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `mcu`
  MODIFY `id_mcu` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `registrasi`
  MODIFY `id_reg` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `rontgen`
--
ALTER TABLE `rontgen`
  MODIFY `id_xray` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
