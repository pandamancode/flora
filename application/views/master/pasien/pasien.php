	...
	<div class="col-md-12">
		<div class="box box-primary">
			<div class="box-header">
				...
				<a href="javascript:;" class="btn-add pull-right"><i class="fa fa-user-plus fa-fw"></i> Tambah
					Pasien</a>
			</div>
					...
					<table class='table table-striped table-hover' id='tbl'>
						...
						<tbody>
							...
							<tr>
								...
								<td><?=$r->no_telp?></td>
								<td>
									<a href="javascript:;" data-id="<?=$r->nik?>"
										class="btn btn-success btn-xs btn-update"><i class="fa fa-edit"></i></a>
									<a href="javascript:;" data-id="<?=$r->nik?>"
										class="btn btn-danger btn-xs btn-flat hapus-data" data-toggle="modal"
										data-target="#konfirmasiHapus"><i class="fa fa-trash"></i></a>
								</td>
							</tr>
							<?php } ?>
						</tbody>
				...
				<form method="post" action="<?php echo base_url() ?>pasien/hapus">
					...
					<div class="col-md-6">
						<button type="submit" class="form-control btn btn-primary"> <i
								class="glyphicon glyphicon-ok-sign"></i> Ya, Hapus Data Ini</button>
					</div>
					<div class="col-md-6">
						<button class="form-control btn btn-danger" data-dismiss="modal"> <i
								class="glyphicon glyphicon-remove-sign"></i> Tidak</button>
					</div>
				</form>
			</div>
		</div>
