...
<form method="post" action="<?php echo base_url() ?>pasien/update_pasien" enctype="multipart/form-data">
  <div class="modal-body" style="max-height: calc(100vh - 210px);  overflow-y: auto;">
      <div class="row">     
        ...
        <div class="form-group col-md-6">
          <label> Alamat :</label>
          <input type="text" name="alamat" class="form-control" value="<?=$pasien->alamat?>" placeholder="Alamat" required autocomplete="off">
        </div>
        <div class="form-group col-md-6">
        ...
        <div class="form-group col-md-6 khusus">
          ...
          <input type="text"  name="instansi" value="<?=$pasien->instansi?>" class="form-control" placeholder="Instansi" required autocomplete="off">
        </div>
        <div class="form-group col-md-6 khusus">
          <label> Satuan Kerja :</label>
          <input type="text"  name="satuan_kerja" value="<?=$pasien->satuan_kerja?>" class="form-control" placeholder="Satuan Kerja" required autocomplete="off">
        </div>
        <div class="form-group col-md-6 khusus">
          <label> Bagian :</label>
          <input type="text"  name="bagian" value="<?=$pasien->bagian?>" class="form-control" placeholder="Bagian" required autocomplete="off">
        </div>
        <div class="form-group col-md-6 khusus">
          <label> Pangkat :</label>
          <input type="text"  name="pangkat" value="<?=$pasien->pangkat?>" class="form-control" placeholder="Pangkat" required autocomplete="off">
        </div>
