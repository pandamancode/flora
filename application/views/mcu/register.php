      ...
      <form method="post" action="<?=base_url()?>Register_mcu/entry_data">
        <div class="box box-body">
          ...
          <div class="form-group col-md-6">
            ...
            <input type="text" name="no_mcu" id="no_mcu" class="form-control" placeholder="No. MCU" required
              autocomplete="off">
          </div>
          ...
          <div class="form-group col-md-6">
            ...
            <div class="input-group">
              ...
              <span class="input-group-btn">
                <button type="button" class="btn btn-success btn-flat btn-browse"><i
          ...
          <div class="form-group col-md-12">
            ...
            <input type="text" name="nama_pasien" id="nama" class="form-control" placeholder="Nama Pasien"
              autocomplete="off" readonly>
          </div>
          <div class="form-group col-md-6">
            <label><i>Tgl Lahir</i></label>
            <input type="text" name="tgl_lahir" id="tgl" class="form-control" placeholder="Tanggal Lahir" readonly
              autocomplete="off">
          </div>
          <div class="form-group col-md-6">
            <label><i>No.Telp</i></label>
            <input type="text" name="no_telp" id="telp" class="form-control" placeholder="No. Telp" readonly
              autocomplete="off">
          </div>
          <div class="form-group col-md-12">
            <label><i>Alamat</i></label>
            <textarea name="alamat" class="form-control" id="alamat" placeholder="Alamat" readonly
