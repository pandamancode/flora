  ...
  <div class="col-md-12">
      <div class="box box-primary box-solid">
        ...
        <i class="fa fa-filter "></i>
          <h3 class="box-title">Filter Data Rekap Pelayanan Petugas</h3>
          ...
          <div class="col-md-3">
            <div class="form-group">
              <select class="form-control" required="" name="divisi">
                <option selected="" disabled="" value="">-Pilih Divisi/Status-</option>
...
function preview() {
    ...
    $.ajax({
        type:"POST",
        url:"<?php echo base_url(); ?>Laporan/filter_rekap_petugas",
        data:dataString,
