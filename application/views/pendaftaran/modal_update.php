  ...
  <div class="modal-body" style="max-height: calc(100vh - 210px);  overflow-y: auto;">
    <div class="row">
      ...
      <div class="form-group col-md-6">
        ...
        <input type="text" value="<?=$pasien->pekerjaan?>" name="pekerjaan" class="form-control" placeholder="Pekerjaan"
          required autocomplete="off">
      </div>
      <div class="form-group col-md-12">
        <label> Alergi Obat :</label>
        <input type="text" value="<?=$pasien->alergi?>" name="alergi_obat" class="form-control"
          placeholder="Alergi Obat" required autocomplete="off">
      </div>
      <div class="form-group col-md-12">
        <label> Alamat :</label>
        <textarea name="alamat" class="form-control" placeholder="Alamat" required
          autocomplete="off"><?=$pasien->alamat?></textarea>
      </div>
    </div>
  </div>
